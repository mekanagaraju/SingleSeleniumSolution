package com.sss.basetest;

/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
 * Author: Nagaraju.Meka
 * File: SSSBaseTest.java
 * Created: 11/25/16
...
import com.sss.webfunctions.SSSController;
import com.sss.webfunctions.WebController;

public class SSSBaseTest
{
   protected static final Logger log = LoggerFactory.getLogger(SSSBaseTest.class);
   protected SSSController sssController = new SSSController();
   protected WebController webController;


   public void setWebFunctions(WebController controller)
   {
